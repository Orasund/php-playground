...
*************************************************************/
$dbname = 'db323934-main';
$link = mysql_connect("localhost","user323934","*ekat00*") or die("Couldn't make connection.");
...
/*************** reCAPTCHA KEYS****************/
$publickey = "6Led_QkAAAAAAH23ufT5JaipytZXz7ALv77gws6P";
$privatekey = "6Led_QkAAAAAADT4_K7gc8ztIiHzYwNSHMh6cSec";
...
$smtp_host = "smtp.web.de";  // SMTP server Example: mail.example.com
$smtp_user = "herosmith@web.de";  // SMTP Username - Example: auto-reply@domain.com
$smtp_passwd = "0987654321"; // SMTP password

$smtp_from     = "herosmith@web.de"; // Example: auto-reply@example.com
