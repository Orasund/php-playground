    ...
    <td width="77%"><h2>Search Results</h2>
      ...
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td>
		    <a href="#" onclick='$.get("do.php",{ cmd: "approve", id: "<? echo $rrows['id']; ?>" } ,function(data){ $("#approve<? echo $rrows['id']; ?>").html(data); });'>Approve</a> 
            <a href="#" onclick='$.get("do.php",{ cmd: "ban", id: "<? echo $rrows['id']; ?>" } ,function(data){ $("#ban<? echo $rrows['id']; ?>").html(data); });'>Ban</a> 
			<a href="#" onclick='$.get("do.php",{ cmd: "unban", id: "<? echo $rrows['id']; ?>" } ,function(data){ $("#ban<? echo $rrows['id']; ?>").html(data); });'>Unban</a>
			</td>
        </tr>
        <? } ?>
        <tr> 
